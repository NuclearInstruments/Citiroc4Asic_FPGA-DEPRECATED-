from NEWCitirocDesignforDT0WReadoutsoftware_Functions import *
from ctypes import *
...
if (count > 0):
	...
	SetIICControllerBaseAddress(NEWCitirocDesignforDT0WReadoutsoftware_RegisterFile.SCI_REG_i2c_master_0_CTRL, NEWCitirocDesignforDT0WReadoutsoftware_RegisterFile.SCI_REG_i2c_master_0_MON, handle)
	voltage=0
	target_voltage=55
